...
var level1 = Level.create_level("level1", "octaves are 2^n times frequency", ["A", "G"], ["Oc", "Oc", "2Oc"], ["2Oc->Oc", "Oc->Oc", "Oc->Hi->Lo", "2Oc->2Oc", "Oc->Oc->Oc", "Oc->2Oc"])
...
["B", "C", "F", "G"], ["Hi", "Lo", "Lo"], ["Hi", "Lo->Hi->Hi", "Lo->Lo->Hi", "Lo->Hi->Hi", "Lo->Lo->Hi"],
["Con", "Con", "Con", "Con", "Dis", "Dis", "Con", "Con"], 3)
