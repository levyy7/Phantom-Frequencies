...
var level3 = Level.create_advanced_level("level3", "consonance, dissonance", note_names, ["Hi", "Lo", "Lo"], ["Hi", "Lo->Hi->Hi", "Lo->Lo->Hi", "Lo->Hi->Hi", "Lo->Lo->Hi"], ["Con", "Con", "Dis", "Con"])
...
var levels = [levelTest, levelTest2, level0, level1, level2, level3]
